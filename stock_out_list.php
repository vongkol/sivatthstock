...
<?php include 'header.php';?>
      ...
      <h3>Stock Out List</h3><br>
<h3> <a href="stock_out_form.php?in_no=<?php echo $id;?>" class="btn btn-primary">Add New</a></h3>
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table id="example" class="display nowrap" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                        $conn = "SELECT * FROM stock_out_form A INNER JOIN branch B ON A.dept=B.branch_id INNER JOIN employee C ON A.check_by=C.emp_id WHERE A.approve=1 ";
                                          $result = $connect->query($conn);
                                           $i=1;
                                          ...
                                          <tr>
                                            ...
                                            ?>
                                            	...
                                            	<a onclick = "return confirm('Are you sure to delete ?');" href="stock_out_delete.php?id=<?php echo $row['sto_out_id']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a> </td>
                                            <?php
                                             } else {
                                            ?>
                                             	<a onclick = "return confirm('Are you sure to delete ?');" href="stock_out_delete.php?id=<?php echo $row['sto_out_id']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a> </td>
