...
$time = date("Y-m-d h:i:A");
    if(isset($_GET["id"])){
  	...
  	if(!empty($_POST["id"])){
        ...
        $sql = "INSERT INTO stockout_report
              (date_in,code_in,pro_id,qty_in,qty_left,qty_minus ,price ,amount,payamount,rest_amount,expire_date,note_reportin,vender_id,emp_id) 
          VALUES 
              ('$date', '$code', '$product', '$balance', '$left', '$minus', '$price', '$amount', '$payamount', '$rest', '$expire', '$note', '$vender', '$employee')";
         $result = mysqli_query($connect, $sql);
...
<?php include 'header.php';?>
	<ol class="breadcrumb">
        ...
        <li>Stock In List</li>
        <li class="active">Minus Product</li>
      </ol>
	<div class="row">
                   	...
                   	<div class = "panel-body">
						...
						<form method="post" enctype="multipart/form-data" action="">     
                          ...
                          <div class="form-group col-xs-6">
                            ...
                            <input class="form-control quantity"   required name="minus" type="number" placeholder="Minus" >
                          </div>
                          <div class="form-group col-xs-6">
