...
if ($total == 0 ){
  ...
  echo "<script>alert('Please Choose Product Befor Total  !');
    ...
    $update = "UPDATE invoice SET amount = '$total',
      ...
      header("location:previewa5.php?invoice=$invoice");
      }
else{

    $insert = "INSERT INTO invoice (inv_no, cashier_name , cus , date_sell , amount , vat , pay) 
    VALUES ( '$invoice' , '$cashier' , '$cus' , '$date' , '$total' , '$vat' , '$pay')";
