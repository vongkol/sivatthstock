    ...
    <div class="container-fluid">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <a href="stock_out_approve.php" class="btn btn-info">Back <i class="fa fa-undo"></i></a>
                </div>
...
//                            die();
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                        <a  href="stock_out_detail_ok.php?id=<?php echo $row2['ind_no']; ?>" class="btn btn-success btn-sm"><i class="fa fa-check" aria-hidden="true"></i></a>
                                        <a onclick="return confirm('Are you sure to delete ?');" href="stock_out_detail_delete.php?ind_no=<?php echo $row2['ind_no']; ?>&in_no=<?php echo $id;?>" class="btn btn-danger btn-sm"><i class="fa fa-times" aria-hidden="true"></i></a></td>
                                    </tr>
                                    <?php endwhile;?>
                            </tbody>
                            <tfoot>
